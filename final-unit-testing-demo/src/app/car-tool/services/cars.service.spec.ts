...
describe('CarsService', () => {
  ...
  it('should replace a car', () => {
    ...
    // put the new car
    const req2 = http.expectOne('http://localhost:3060/cars/1');
